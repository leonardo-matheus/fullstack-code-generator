<template>
  <div
    v-if="show"
    :class="`${fade} lv-banner row justify-between`"
    :style="styles"
  >
    ...
    <div
      v-if="isDismissable"
      :class="`${isDismissable ? 'col-1' : ''} text-right`"
    >
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const styles = computed(() => {
      ...
      if (props.textColor && props.textColor !== "primary")
        txtColor = getColor(props.textColor);
