<template>
  <div class="root row q-pa-md">
    ...
    <div class="col-12 offset-sm-3 col-sm-5 animated zoomIn">
      <q-form
        @submit="submit"
        class="col-12 bg-white shadow q-mt-lg q-pa-md radius"
      >
        <lv-input
          top-label
          type="password"
          label="Current Password*"
          v-model="dataModel.current_password"
          :rules="$Handler.rules(dataModel.current_password, 'required')"
        />
        <lv-input
          top-label
          type="password"
          ...
          :rules="$Handler.rules(dataModel.password, 'required')"
        />
        <lv-input
          top-label
          type="password"
          ...
          v-model="repeat"
          :rules="$Handler.rules(dataModel.repeat, 'required')"
        />
