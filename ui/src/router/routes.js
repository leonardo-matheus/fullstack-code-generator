  ...
  },
  {
    ...
    children: [
      ...
      // accounts
      {
        ...
        component: () => import("../pages/accounts/update-profile.vue"),
      },
      {
        name: "change-password",
        path: "/me/change-password",
        component: () => import("../pages/accounts/change-password.vue"),
      },
      {
        name: "notifications",
        path: "/me/notifications",
        component: () => import("../pages/accounts/notifications.vue"),
      },
    ],
  },
];
  ...
  var obj = {
    ...
    children: [
      ...
      },
      {
        name: `${name}-detail`,
        path: `/${name}/:id`,
        component: () => import(`pages/${name}/detail.vue`),
      },
      {
        name: `${name}-add`,
        path: `/${name}/form`,
        component: () => import(`pages/${name}/form.vue`),
      },
      {
        name: `${name}-edit`,
        path: `/${name}/form/:id`,
